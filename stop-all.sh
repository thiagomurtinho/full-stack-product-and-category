...
echo "- npm run dev              # Start in interactive mode (DEFAULT)"
echo "- npm run start            # Start in interactive mode"
echo "- npm run start:prod       # Start in production mode"
echo "- bash setup.sh            # Interactive setup (DEFAULT)"
echo "- bash setup-production.sh # Production setup"
echo "" 